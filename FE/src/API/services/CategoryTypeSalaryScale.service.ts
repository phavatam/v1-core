...
export const CategoryTypeSalaryScaleApisService = createApi({
  ...
  endpoints: (builder) => ({
    ...
    UpdateCategoryTypeSalaryScale: builder.mutation<
      payloadResult,
      { CategoryTypeSalaryScale: Partial<CategoryTypeSalaryScaleDTO> }
    >({
    ...
    GetCategoryTypeSalaryScaleById: builder.query<
      ListResponse<CategoryTypeSalaryScaleDTO>,
      { idCategoryTypeSalaryScale: string }
    >({
      ...
      providesTags: (result, error, arg) => [
        { type: "CategoryTypeSalaryScaleApisService", id: arg.idCategoryTypeSalaryScale }
      ]
    }),
    InsertCategoryTypeSalaryScale: builder.mutation<
      payloadResult,
      { CategoryTypeSalaryScale: Partial<CategoryTypeSalaryScaleDTO> }
    >({
      query: ({ CategoryTypeSalaryScale }) => ({
