import { Button, Col, Form, Input, Popconfirm, Row, Select, Space, Spin, Tooltip, TreeSelect } from "antd";
        ...
        <Form onFinish={onfinish} layout={"horizontal"} labelCol={{ span: 4 }} form={formRef}>
          ...
          <Row>
            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
              ...
              <Form.Item name={"positions"} label="Chức danh người dùng">
                <Select allowClear showSearch placeholder={"Chọn chức danh"}>
                  <Select.Option value="VCQL">Viên chức quản lý</Select.Option>
                  <Select.Option value="VCGV">Viên chức giáo viên</Select.Option>
                  <Select.Option value="VCNV">Viên chức nhân viên</Select.Option>
                  <Select.Option value="LDHD">Lao động hợp đồng</Select.Option>
                </Select>
              </Form.Item>
