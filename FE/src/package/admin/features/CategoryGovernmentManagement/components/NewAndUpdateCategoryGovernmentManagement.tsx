...
function _NewAndUpdateCategoryGovernmentManagement(props: IProps) {
  ...
  const { data: CategoryGovernmentManagement, isLoading: LoadingCategoryGovernmentManagement } =
    useGetCategoryGovernmentManagementByIdQuery({ idCategoryGovernmentManagement: id! }, { skip: !id });
  const [newCategoryGovernmentManagement, { isLoading: LoadingInsertCategoryGovernmentManagement }] =
    useInsertCategoryGovernmentManagementMutation();
  const [updateCategoryGovernmentManagement, { isLoading: LoadingUpdateCategoryGovernmentManagement }] =
    useUpdateCategoryGovernmentManagementMutation();
...
export const NewAndUpdateCategoryGovernmentManagement = WithErrorBoundaryCustom(
  _NewAndUpdateCategoryGovernmentManagement
);
