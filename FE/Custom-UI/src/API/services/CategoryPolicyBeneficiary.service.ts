...
export const CategoryPolicyBeneficiaryApisService = createApi({
  ...
  endpoints: (builder) => ({
    ...
    UpdateCategoryPolicyBeneficiary: builder.mutation<
      payloadResult,
      { CategoryPolicyBeneficiary: Partial<CategoryPolicyBeneficiaryDTO> }
    >({
    ...
    GetCategoryPolicyBeneficiaryById: builder.query<
      ListResponse<CategoryPolicyBeneficiaryDTO>,
      { idCategoryPolicybeneficiary: string }
    >({
      ...
      providesTags: (result, error, arg) => [
        { type: "CategoryPolicyBeneficiaryApisService", id: arg.idCategoryPolicybeneficiary }
      ]
    }),
    InsertCategoryPolicyBeneficiary: builder.mutation<
      payloadResult,
      { CategoryPolicyBeneficiary: Partial<CategoryPolicyBeneficiaryDTO> }
    >({
      query: ({ CategoryPolicyBeneficiary }) => ({
