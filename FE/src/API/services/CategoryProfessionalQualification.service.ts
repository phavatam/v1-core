...
export const CategoryProfessionalQualificationApisService = createApi({
  ...
  endpoints: (builder) => ({
    GetListCategoryProfessionalQualification: builder.query<
      ListResponse<CategoryProfessionalQualificationDTO>,
      pagination
    >({
    ...
    UpdateCategoryProfessionalQualification: builder.mutation<
      payloadResult,
      { CategoryProfessionalQualification: Partial<CategoryProfessionalQualificationDTO> }
    >({
    ...
    GetCategoryProfessionalQualificationById: builder.query<
      ListResponse<CategoryProfessionalQualificationDTO>,
      { idCategoryProfessionalQualification: string }
    >({
      ...
      providesTags: (result, error, arg) => [
        { type: "CategoryProfessionalQualificationApisService", id: arg.idCategoryProfessionalQualification }
      ]
    }),
    InsertCategoryProfessionalQualification: builder.mutation<
      payloadResult,
      { CategoryProfessionalQualification: Partial<CategoryProfessionalQualificationDTO> }
    >({
      query: ({ CategoryProfessionalQualification }) => ({
      ...
      invalidatesTags: (result) =>
        result ? [{ type: "CategoryProfessionalQualificationApisService", id: "LIST" }] : []
    }),
    DeleteCategoryProfessionalQualification: builder.mutation<
      payloadResult,
      { idCategoryProfessionalQualification: string[] }
    >({
