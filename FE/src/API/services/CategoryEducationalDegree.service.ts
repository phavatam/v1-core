...
export const CategoryEducationalDegreeApisService = createApi({
  ...
  endpoints: (builder) => ({
    ...
    UpdateCategoryEducationalDegree: builder.mutation<
      payloadResult,
      { CategoryEducationalDegree: Partial<CategoryEducationalDegreeDTO> }
    >({
    ...
    GetCategoryEducationalDegreeById: builder.query<
      ListResponse<CategoryEducationalDegreeDTO>,
      { idCategoryEducationalDegree: string }
    >({
      ...
      providesTags: (result, error, arg) => [
        { type: "CategoryEducationalDegreeApisService", id: arg.idCategoryEducationalDegree }
      ]
    }),
    InsertCategoryEducationalDegree: builder.mutation<
      payloadResult,
      { CategoryEducationalDegree: Partial<CategoryEducationalDegreeDTO> }
    >({
      query: ({ CategoryEducationalDegree }) => ({
