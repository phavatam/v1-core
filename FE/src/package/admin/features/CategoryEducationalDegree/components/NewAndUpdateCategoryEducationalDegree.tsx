...
function _NewAndUpdateCategoryEducationalDegree(props: IProps) {
  ...
  const { data: CategoryEducationalDegree, isLoading: LoadingCategoryEducationalDegree } =
    useGetCategoryEducationalDegreeByIdQuery({ idCategoryEducationalDegree: id! }, { skip: !id });
  const [newCategoryEducationalDegree, { isLoading: LoadingInsertCategoryNationaly }] =
    useInsertCategoryEducationalDegreeMutation();
  const [updateCategoryEducationalDegree, { isLoading: LoadingUpdateCategoryNationaly }] =
    useUpdateCategoryEducationalDegreeMutation();
