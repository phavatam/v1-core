...
function _NewAndUpdateCategoryTypeSalaryScale(props: IProps) {
  ...
  const { data: CategoryTypeSalaryScale, isLoading: LoadingCategoryTypeSalaryScale } =
    useGetCategoryTypeSalaryScaleByIdQuery({ idCategoryTypeSalaryScale: id! }, { skip: !id });
  const [newCategoryTypeSalaryScale, { isLoading: LoadingInsertCategoryNationaly }] =
    useInsertCategoryTypeSalaryScaleMutation();
  const [updateCategoryTypeSalaryScale, { isLoading: LoadingUpdateCategoryNationaly }] =
    useUpdateCategoryTypeSalaryScaleMutation();
