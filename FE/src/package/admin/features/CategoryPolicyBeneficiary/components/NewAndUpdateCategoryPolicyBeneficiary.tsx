...
function _NewAndUpdateCategoryPolicyBeneficiary(props: IProps) {
  ...
  const { data: CategoryPolicyBeneficiary, isLoading: LoadingCategoryPolicyBeneficiary } =
    useGetCategoryPolicyBeneficiaryByIdQuery({ idCategoryPolicybeneficiary: id! }, { skip: !id });
  const [newCategoryPolicyBeneficiary, { isLoading: LoadingInsertCategoryPolicyBeneficiary }] =
    useInsertCategoryPolicyBeneficiaryMutation();
  const [updateCategoryPolicyBeneficiary, { isLoading: LoadingUpdateCategoryPolicyBeneficiary }] =
    useUpdateCategoryPolicyBeneficiaryMutation();
