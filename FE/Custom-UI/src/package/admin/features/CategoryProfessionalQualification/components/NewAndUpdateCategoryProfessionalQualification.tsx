...
function _NewAndUpdateCategoryProfessionalQualification(props: IProps) {
  ...
  const { data: CategoryProfessionalQualification, isLoading: LoadingCategoryProfessionalQualification } =
    useGetCategoryProfessionalQualificationByIdQuery({ idCategoryProfessionalQualification: id! }, { skip: !id });
  const [newCategoryProfessionalQualification, { isLoading: LoadingInsertCategoryProfessionalQualification }] =
    useInsertCategoryProfessionalQualificationMutation();
  const [updateCategoryProfessionalQualification, { isLoading: LoadingUpdateCategoryProfessionalQualification }] =
    useUpdateCategoryProfessionalQualificationMutation();
              ...
              <Form.Item>
                ...
                >
                  <Button
                    ...
                    htmlType="reset"
                    loading={
                      LoadingInsertCategoryProfessionalQualification || LoadingUpdateCategoryProfessionalQualification
                    }
...
export const NewAndUpdateCategoryProfessionalQualification = WithErrorBoundaryCustom(
  _NewAndUpdateCategoryProfessionalQualification
);
