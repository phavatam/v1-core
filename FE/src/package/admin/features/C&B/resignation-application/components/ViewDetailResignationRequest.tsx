...
function _ViewDetailResignationRequest(props: ViewDetailInternRequestProps) {
...
export const ViewDetailResignationRequest = WithErrorBoundaryCustom(_ViewDetailResignationRequest);
