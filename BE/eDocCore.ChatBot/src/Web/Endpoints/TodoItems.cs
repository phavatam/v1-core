...
using eDocCore.ChatBot.Application.TodoItems.Commands.CreateTodoItem;
using eDocCore.ChatBot.Application.TodoItems.Commands.DeleteTodoItem;
using eDocCore.ChatBot.Application.TodoItems.Commands.UpdateTodoItem;
using eDocCore.ChatBot.Application.TodoItems.Commands.UpdateTodoItemDetail;
using eDocCore.ChatBot.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace eDocCore.ChatBot.Web.Endpoints;
