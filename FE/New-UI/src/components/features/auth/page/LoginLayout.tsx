...
import { LoginOutlined, UnlockOutlined, AimOutlined } from "@ant-design/icons";
import { HandleError } from "../../../../components";
import { Illustration3 } from "../../../asset/Illustrations";
...
function _LoginLayout() {
  ...
  const onFinish = async (values: { loginName: string; password: string }) => {
    try {
      ...
      const result = await AuthService.login({ user: values });
