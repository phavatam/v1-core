  ...
  function F(e, r, f, p, m, F, P) {
    const {
        ...
        (n) =>
          ((
            ...
            const f = n.settled(),
              p = !a.shouldConstrain(),
              m = d ? f : f && p;
            m && !c.pointerDown() && (u.stop(), s.emit("settle")),
              m || s.emit("scroll");
            const g = e.get() * l + wn.get() * (1 - l);
      ...
      zn = {
        ...
        scrollBody: Dn,
        scrollBounds: w(gn, En, Ln, Dn, _),
        scrollLooper: E(ln, gn, En, [Sn, En, wn, Ln]),
        scrollProgress: Mn,
        scrollSnapList: mn.map(Mn.get),
        scrollSnaps: mn,
        scrollTarget: In,
        scrollTo: An,
        slideLooper: A(K, Z, ln, rn, on, an, mn, En, f),
        slideFocus: Pn,
        slidesHandler: M(r, P, $),
        slidesInView: On,
        slideIndexes: yn,
