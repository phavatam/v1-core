...
export const CategoryGovernmentManagementApisService = createApi({
  ...
  endpoints: (builder) => ({
    ...
    UpdateCategoryGovernmentManagement: builder.mutation<
      payloadResult,
      { CategoryGovernmentManagement: Partial<CategoryGovernmentManagementDTO> }
    >({
    ...
    GetCategoryGovernmentManagementById: builder.query<
      ListResponse<CategoryGovernmentManagementDTO>,
      { idCategoryGovernmentManagement: string }
    >({
      ...
      providesTags: (result, error, arg) => [
        { type: "CategoryGovernmentManagementApisService", id: arg.idCategoryGovernmentManagement }
      ]
    }),
    InsertCategoryGovernmentManagement: builder.mutation<
      payloadResult,
      { CategoryGovernmentManagement: Partial<CategoryGovernmentManagementDTO> }
    >({
      query: ({ CategoryGovernmentManagement }) => ({
